...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x6f, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x09,
	0x5a, 0x07, 0x2f, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_laptop_service_proto_goTypes = []interface{}{
	...
	(*Laptop)(nil),               // 4: app.pcbook.Laptop
	(*Filter)(nil),               // 5: app.pcbook.Filter
}
var file_laptop_service_proto_depIdxs = []int32{
	4, // 0: app.pcbook.CreateLaptopRequest.laptop:type_name -> app.pcbook.Laptop
	5, // 1: app.pcbook.SearchLaptopRequest.filter:type_name -> app.pcbook.Filter
	4, // 2: app.pcbook.SearchLaptopResponse.laptop:type_name -> app.pcbook.Laptop
	0, // 3: app.pcbook.LaptopService.CreateLaptop:input_type -> app.pcbook.CreateLaptopRequest
	2, // 4: app.pcbook.LaptopService.SearchLaptop:input_type -> app.pcbook.SearchLaptopRequest
	1, // 5: app.pcbook.LaptopService.CreateLaptop:output_type -> app.pcbook.CreateLaptopResponse
	3, // 6: app.pcbook.LaptopService.SearchLaptop:output_type -> app.pcbook.SearchLaptopResponse
