...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=app.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x0e, 0x32, 0x17, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: app.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: app.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: app.pcbook.Memory.unit:type_name -> app.pcbook.Memory.Unit
