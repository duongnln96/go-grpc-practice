...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=app.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x2e, 0x61, 0x70, 0x70, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53, 0x63, 0x72, 0x65,
	...
	0x65, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x70,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: app.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: app.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: app.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: app.pcbook.Screen.resolution:type_name -> app.pcbook.Screen.Resolution
	0, // 1: app.pcbook.Screen.panel:type_name -> app.pcbook.Screen.Panel
