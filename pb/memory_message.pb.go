...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=duongnln.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x64, 0x75, 0x6f, 0x6e, 0x67, 0x6e, 0x6c,
	0x6e, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x2e,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: duongnln.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: duongnln.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: duongnln.pcbook.Memory.unit:type_name -> duongnln.pcbook.Memory.Unit
