...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=duongnln.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x64, 0x75, 0x6f, 0x6e, 0x67, 0x6e, 0x6c, 0x6e, 0x2e, 0x70,
	...
	0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x64, 0x75, 0x6f, 0x6e, 0x67, 0x6e, 0x6c, 0x6e, 0x2e, 0x70, 0x63,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: duongnln.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: duongnln.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: duongnln.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: duongnln.pcbook.Screen.resolution:type_name -> duongnln.pcbook.Screen.Resolution
	0, // 1: duongnln.pcbook.Screen.panel:type_name -> duongnln.pcbook.Screen.Panel
